...
public class AverageDriver extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        job.setMapperClass(AverageMR.AverageMapper.class);
        job.setMapOutputKeyClass(Text.class);
        job.setMapOutputValueClass(AverageTuple.class);
        job.setReducerClass(AverageMR.AverageReducer.class);
    ...
    public static void main(String[] args)throws Exception{
        ...
        System.exit(ToolRunner.run(conf, new AverageDriver(), otherArgs));
    }
}
