...
public class DistinctDriver extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        job.setMapperClass(DistinctMR.DistinctMapper.class);
        job.setMapOutputKeyClass(Text.class);
        job.setMapOutputValueClass(NullWritable.class);
        job.setReducerClass(DistinctMR.DistinctReducer.class);
    ...
    public static void main(String[] args)throws Exception{
        ...
        System.exit(ToolRunner.run(conf, new DistinctDriver(), otherArgs));
    }
}
